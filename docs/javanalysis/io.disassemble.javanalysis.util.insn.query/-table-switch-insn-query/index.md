[javanalysis](../../index.md) / [io.disassemble.javanalysis.util.insn.query](../index.md) / [TableSwitchInsnQuery](./index.md)

# TableSwitchInsnQuery

`class TableSwitchInsnQuery : `[`InsnQuery`](../-insn-query/index.md)`<`[`TableSwitchInsn`](../../io.disassemble.javanalysis.insn/-table-switch-insn/index.md)`>`
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `TableSwitchInsnQuery()`<br>A class representing a query for an [TableSwitchInsn](../../io.disassemble.javanalysis.insn/-table-switch-insn/index.md). Used for filtering in lists. |
