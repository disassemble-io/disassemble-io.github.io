---
title: TableSwitchInsnQuery - javanalysis
---

[javanalysis](../../index.html) / [io.disassemble.javanalysis.util.insn.query](../index.html) / [TableSwitchInsnQuery](./index.html)

# TableSwitchInsnQuery

`class TableSwitchInsnQuery : `[`InsnQuery`](../-insn-query/index.html)`<`[`TableSwitchInsn`](../../io.disassemble.javanalysis.insn/-table-switch-insn/index.html)`>`
...
| [&lt;init&gt;](-init-.html) | `TableSwitchInsnQuery()`<br>A class representing a query for an [TableSwitchInsn](../../io.disassemble.javanalysis.insn/-table-switch-insn/index.html). Used for filtering in lists. |
