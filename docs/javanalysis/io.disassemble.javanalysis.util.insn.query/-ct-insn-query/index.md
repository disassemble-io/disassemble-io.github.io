---
title: CtInsnQuery - javanalysis
---

[javanalysis](../../index.html) / [io.disassemble.javanalysis.util.insn.query](../index.html) / [CtInsnQuery](./index.html)

# CtInsnQuery

`class CtInsnQuery : `[`InsnQuery`](../-insn-query/index.html)`<`[`CtInsn`](../../io.disassemble.javanalysis.insn/-ct-insn/index.html)`>`
...
| [&lt;init&gt;](-init-.html) | `CtInsnQuery()`<br>A class representing a query for an [CtInsn](../../io.disassemble.javanalysis.insn/-ct-insn/index.html). Used for filtering in lists. |
