[javanalysis](../../index.md) / [io.disassemble.javanalysis.util.insn.query](../index.md) / [WideInsnQuery](./index.md)

# WideInsnQuery

`class WideInsnQuery : `[`InsnQuery`](../-insn-query/index.md)`<`[`WideInsn`](../../io.disassemble.javanalysis.insn/-wide-insn/index.md)`>`
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `WideInsnQuery()`<br>A class representing a query for an [WideInsn](../../io.disassemble.javanalysis.insn/-wide-insn/index.md). Used for filtering in lists. |
...
| Name | Summary |
|---|---|
| [wideIndex](wide-index.md) | `fun wideIndex(wideIndex: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`): `[`WideInsnQuery`](./index.md)<br>Adds a condition to [InsnQuery.conditions](../-insn-query/conditions.md) in which [WideInsn.wideIndex](../../io.disassemble.javanalysis.insn/-wide-insn/wide-index.md) must match the given value. |
| [wideOp](wide-op.md) | `fun wideOp(wideOp: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`): `[`WideInsnQuery`](./index.md)<br>Adds a condition to [InsnQuery.conditions](../-insn-query/conditions.md) in which [WideInsn.wideOp](../../io.disassemble.javanalysis.insn/-wide-insn/wide-op.md) must match the given value. |
