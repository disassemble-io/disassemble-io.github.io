---
title: TypeInsnQuery - javanalysis
---

[javanalysis](../../index.html) / [io.disassemble.javanalysis.util.insn.query](../index.html) / [TypeInsnQuery](./index.html)

# TypeInsnQuery

`class TypeInsnQuery : `[`InsnQuery`](../-insn-query/index.html)`<`[`TypeInsn`](../../io.disassemble.javanalysis.insn/-type-insn/index.html)`>`
...
| [&lt;init&gt;](-init-.html) | `TypeInsnQuery()`<br>A class representing a query for an [TypeInsn](../../io.disassemble.javanalysis.insn/-type-insn/index.html). Used for filtering in lists. |
...
| [type](type.html) | `fun type(type: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`): `[`TypeInsnQuery`](./index.html)<br>Adds a condition to [InsnQuery.conditions](../-insn-query/conditions.html) in which [TypeInsn.type](../../io.disassemble.javanalysis.insn/-type-insn/type.html) must match the given value. |
