[javanalysis](../../index.md) / [io.disassemble.javanalysis.util.insn.query](../index.md) / [TypeInsnQuery](./index.md)

# TypeInsnQuery

`class TypeInsnQuery : `[`InsnQuery`](../-insn-query/index.md)`<`[`TypeInsn`](../../io.disassemble.javanalysis.insn/-type-insn/index.md)`>`
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `TypeInsnQuery()`<br>A class representing a query for an [TypeInsn](../../io.disassemble.javanalysis.insn/-type-insn/index.md). Used for filtering in lists. |
...
| Name | Summary |
|---|---|
| [type](type.md) | `fun type(type: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`): `[`TypeInsnQuery`](./index.md)<br>Adds a condition to [InsnQuery.conditions](../-insn-query/conditions.md) in which [TypeInsn.type](../../io.disassemble.javanalysis.insn/-type-insn/type.md) must match the given value. |
