---
title: JumpInsn - javanalysis
---

[javanalysis](../../index.html) / [io.disassemble.javanalysis.insn](../index.html) / [JumpInsn](./index.html)

# JumpInsn

`class JumpInsn : `[`CtInsn`](../-ct-insn/index.html)
...
| [&lt;init&gt;](-init-.html) | `JumpInsn(owner: CtMethod, index: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`)`<br>A class representing a jump instruction. |

### Properties

| [target](target.html) | `val target: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)<br>The position to jump to. |
