...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `TypeInsn(owner: CtMethod, index: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`)` |
...
| Name | Summary |
|---|---|
| [MultiANewArrayInsn](../-multi-a-new-array-insn/index.md) | `class MultiANewArrayInsn : `[`TypeInsn`](./index.md) |
