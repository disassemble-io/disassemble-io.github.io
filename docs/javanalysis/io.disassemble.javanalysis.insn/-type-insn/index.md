---
title: TypeInsn - javanalysis
---

[javanalysis](../../index.html) / [io.disassemble.javanalysis.insn](../index.html) / [TypeInsn](./index.html)

# TypeInsn

`open class TypeInsn : `[`CtInsn`](../-ct-insn/index.html)
...
| [&lt;init&gt;](-init-.html) | `TypeInsn(owner: CtMethod, index: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`)`<br>A class representing a typed instruction. |

### Properties

| [type](type.html) | `var type: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)<br>The type of this [TypeInsn](./index.html). |
...
| [MultiANewArrayInsn](../-multi-a-new-array-insn/index.html) | `class MultiANewArrayInsn : `[`TypeInsn`](./index.html)<br>A class representing a multianewarray instruction. |
