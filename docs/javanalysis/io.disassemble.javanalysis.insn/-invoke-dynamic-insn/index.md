---
title: InvokeDynamicInsn - javanalysis
---

[javanalysis](../../index.html) / [io.disassemble.javanalysis.insn](../index.html) / [InvokeDynamicInsn](./index.html)

# InvokeDynamicInsn

`class InvokeDynamicInsn : `[`CtInsn`](../-ct-insn/index.html)
...
| [&lt;init&gt;](-init-.html) | `InvokeDynamicInsn(owner: CtMethod, index: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`)`<br>A class representing a dynamic method instruction. |

### Properties

| [bootstrap](bootstrap.html) | `var bootstrap: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)<br>The bootstrap value of this instruction |
| [type](type.html) | `var type: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)<br>The type of this instruction |
