[javanalysis](../../index.md) / [io.disassemble.javanalysis.insn](../index.md) / [IntInsn](./index.md)

# IntInsn

`class IntInsn : `[`CtInsn`](../-ct-insn/index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `IntInsn(owner: CtMethod, index: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`)`<br>A class representing a numeric instruction. |

### Properties

| Name | Summary |
|---|---|
| [operand](operand.md) | `var operand: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)<br>The value of this instruction. |
